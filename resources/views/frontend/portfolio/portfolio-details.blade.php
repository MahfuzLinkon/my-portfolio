                    ...
                    <aside class="services__sidebar">
                        ...
                        <div class="widget">
                            ...
                            <ul class="sidebar__contact__info">
                                <li><span>Finished Date :</span>{{ $portfolio->finish_date }}</li>
                                <li><span>Location :</span>{{ $portfolio->location }}</li>
                                <li class="cagegory"><span>Category :</span>
                                    <a href="portfolio.html">{{ $portfolio->category->name }}</a>
                                </li>
                                <li><span>Project Link :</span> <a href="{{ $portfolio->link }}">{{ $portfolio->link }}</a></li>
                            </ul>
                        </div>
